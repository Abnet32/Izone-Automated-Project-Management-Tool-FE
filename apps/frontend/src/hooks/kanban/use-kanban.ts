...
const sampleTasks: Task[] = [
  // ... (your exact task data matching the image)
];
...
export function useKanban() {
  ...
  return {
    ...
    moveTask,
    addTask,
    updateTask, // Add this for task editing
  };
}
...
//   // Trello-style simple task addition
//   const addTask = (taskData: { title: string }, columnType: Column['type']) => {
//     const newTask: Task = {
//       id: Date.now().toString(),
//       title: taskData.title,
...
// // // EXACT DATA FROM YOUR IMAGE
// // const sampleTasks: Task[] = [
// //   // ... (keep your existing sample tasks data)
// // ];
...
// // //       tasks: tasks.filter(task => {
// // //         if (column.type === 'review' && column.position === 4) {
// // //           // Second review column gets specific tasks
// // //           return task.status === 'review' && ['10', '11'].includes(task.id);
// // //         }
// // //         return task.status === column.type;
// // //       })
