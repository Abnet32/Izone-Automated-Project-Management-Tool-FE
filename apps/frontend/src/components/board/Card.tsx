...
//         onClick={() => setIsModalOpen(true)}
//         className={`
//           bg-white rounded shadow-sm border border-gray-200 p-3 mb-2 cursor-pointer 
...
//                   label === 'high-priority' ? 'bg-red-500 text-white' :
//                   label === 'design' ? 'bg-purple-500 text-white' :
//                   label === 'development' ? 'bg-blue-500 text-white' :
...
//         {/* Card Title */}
//         <p className="text-gray-800 text-sm leading-snug">{card.title}</p>
