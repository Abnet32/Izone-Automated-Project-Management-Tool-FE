...
export function KanbanBoard() {
  const { columns, moveTask, addTask, updateTask, deleteTask } = useKanban(); // ✅ All functions destructured
      ...
      <div className="flex gap-6 overflow-x-auto pb-6">
        {columns.map((column) => (
          <Column
            ...
            onTaskMove={moveTask}
            onTaskAdd={addTask}
            onTaskUpdate={updateTask} // ✅ Pass updateTask
            onTaskDelete={deleteTask} // ✅ Pass deleteTask
          />
        ))}
      </div>
    </div>
